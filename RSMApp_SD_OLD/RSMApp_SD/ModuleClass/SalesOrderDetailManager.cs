...
namespace RSMApp_SD
{
    public class SalesOrderDetailManager
    {
        ...
        public void InsertSalesOrderDetail(SalesOrderDetail argSalesOrderDetail, DataAccess da, List<ErrorHandler> lstErr)
        {
            ...
            param[20] = new SqlParameter("@ClientCode", argSalesOrderDetail.ClientCode);
            param[21] = new SqlParameter("@CreatedBy", argSalesOrderDetail.CreatedBy);
            param[22] = new SqlParameter("@ModifiedBy", argSalesOrderDetail.ModifiedBy);
