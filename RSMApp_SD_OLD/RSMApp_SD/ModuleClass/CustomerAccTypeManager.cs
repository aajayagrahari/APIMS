    ...
    public class CustomerAccTypeManager
    {
       ...
       //  GlobalFunction objGlobalFunction = new GlobalFunction();
        ...
        public void FillCombobox(Telerik.Web.UI.RadComboBox RCBCustomerAccType, string argClientCode, int iIsDeleted)
        {
            ...
            {
                String itemText = dr["CustomerAccTypeCode"].ToString() + " " + dr["CustomerAccTypeDesc"].ToString();
                var itemCollection = new RadComboBoxItem
                {
                    Text = itemText,
                    Value = dr["CustomerAccTypeCode"].ToString()
                };

                itemCollection.Attributes.Add("CustomerAccTypeCode", dr["CustomerAccTypeCode"].ToString());
                itemCollection.Attributes.Add("CustomerAccTypeDesc", dr["CustomerAccTypeDesc"].ToString());
