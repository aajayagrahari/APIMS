...
//Private const string ClassName = "CharactersticValueNumeric"
using System;
...
{
    [Serializable]
    public class CharactersticValueNumeric
    {
        private int _idCharactersticsValue;
        private string _CharactersticsName;
        private double _CharactersticsValue;
        ...
        public double CharactersticsValue
        {
            get
            {
