...
//Private const string ClassName = "SOCategory"
using System;
...
namespace RSMApp_SD
{
    ...
    public class SOCategory
    {
        ...
        private string _SOCategoryDesc;
        ...
        public string SOCategoryDesc
        {
            get
            {
                return _SOCategoryDesc;
            }
            set
            {
                _SOCategoryDesc = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.SOCategoryDesc = Convert.ToString(dr["SOCategoryDesc"]);
