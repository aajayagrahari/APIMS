...
//Private const string ClassName = "VendorGroup"
using System;
...
namespace RSMApp_SD
{
    ...
    public class VendorGroup
    {
        ...
        public string VendGroupDesc
        {
            get
            {
                return _VendGroupDesc;
            }
            set
            {
                _VendGroupDesc = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.VendGroupDesc = Convert.ToString(dr["VendGroupDesc"]);
