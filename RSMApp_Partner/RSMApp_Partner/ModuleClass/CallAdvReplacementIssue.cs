...
//Private const string ClassName = "CallAdvReplacementIssue"
using System;
...
{
    [Serializable]
    public class CallAdvReplacementIssue
    {
        private string _CallAdvRepIssueCode;
        ...
        public string CallAdvRepIssueCode
        {
            get
            {
                return _CallAdvRepIssueCode;
            }
            set
            {
                _CallAdvRepIssueCode = value;
            }
        }
        ...
        {
            this.CallAdvRepIssueCode = Convert.ToString(dr["CallAdvRepIssueCode"]);
