...
//Private const string ClassName = "DCanabalizeDocType"
using System;
...
{
    [Serializable]
    public class DCanabalizeDocType
    {
        private string _DCanablizeDocTypeCode;
        private string _DCanablizeDocTypeDesc;
        ...
        public string DCanablizeDocTypeDesc
        {
            get
            {
                return _DCanablizeDocTypeDesc;
            }
            set
            {
                _DCanablizeDocTypeDesc = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.DCanablizeDocTypeDesc = Convert.ToString(dr["DCanablizeDocTypeDesc"]);
