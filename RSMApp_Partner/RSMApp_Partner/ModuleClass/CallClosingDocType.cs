...
//Private const string ClassName = "CallClosingDocType"
using System;
...
{
    [Serializable]
    public class CallClosingDocType
    {
        private string _CallClosingDocTypeCode;
        private string _CallClosingDocTypeDesc;
        ...
        public string CallClosingDocTypeDesc
        {
            get
            {
                return _CallClosingDocTypeDesc;
            }
            set
            {
                _CallClosingDocTypeDesc = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.CallClosingDocTypeDesc = Convert.ToString(dr["CallClosingDocTypeDesc"]);
