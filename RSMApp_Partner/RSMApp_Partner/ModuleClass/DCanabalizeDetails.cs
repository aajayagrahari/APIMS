...
//Private const string ClassName = "DCanabalizeDetails"
using System;
...
{
    [Serializable]
    public class DCanabalizeDetails
    {
        private string _DCanabalizeDocNo;
        private int _DCanabalizeItemNo;
        ...
        public int DCanabalizeItemNo
        {
            get
            {
                return _DCanabalizeItemNo;
            }
            set
            {
                _DCanabalizeItemNo = value;
            }
        }
        ...
        public void SetObjectInfo(DataRow dr)
        {
            ...
            this.DCanabalizeItemNo = Convert.ToInt32(dr["DCanabalizeItemNo"]);
